...
export default function SessionSectionClient() {
	...
	return (
		<div className='flex gap-2'>
			<Link href={session.user.nickname ? `/${session.user.nickname}` : '/registration'}>
				<div className='rounded-full overflow-hidden h-10 w-10 bg-gray-400 botder border-zinc-700 text-white'>
